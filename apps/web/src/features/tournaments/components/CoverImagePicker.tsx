 ...
 * reports the returned `/api/images/:id` URL via `onChange`. An upload error
 * clears the value and surfaces a message; the field itself is optional (a
 * tournament may have no cover).
 */
